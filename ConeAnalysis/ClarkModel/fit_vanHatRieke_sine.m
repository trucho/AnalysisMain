classdef fit_vanHatRieke_sine < ephysGUI
    properties
        
        coeffs = [526,235,2395,136,0277]; % coeffs for best fit to stj
        guesscoeffs = [526,235,2395,115,1800]; % manual fit to get best one
...
%                 c7: 150 pA
    ...
    methods
        ...
        function hGUI=fit_vanHatRieke_sine(fign)
            % INITIALIZATION
            if nargin == 0
                fign=10;
            end
        ...
        function createData(hGUI,~,~)
            ...
            for i = 1:hGUI.n
                ...
                for s = 1:hGUI.nS
                    ...
                    tempfit=hGUI.vanHatModel(hGUI.coeffs,temptme,tempstm,hGUI.dt,0);
...
%             hGUI.ylim(hGUI.gObj.p_exResp01,[-70 40])
            ...
            temptme=(1:1:length(tempstm))* hGUI.dt;
            tempfit=hGUI.vanHatModel(hGUI.guesscoeffs,temptme,tempstm,hGUI.dt,0);
