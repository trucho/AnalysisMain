...
kGc = 526/1000;		%hillaffinity % affinity for Ca2+ (~0.5*dark Calcium)
sigma = 235/10;			% rhodopsin activity decay rate constant (1/sec) ()
phi = sigma;              % phosphodiesterase activity decay rate constant (1/sec) ()
eta = coef(2);				% phosphodiesterase activation rate constant (1/sec) ()
% eta/phi~duration of response (50ms) (main determinant of response kinetics)
gamma = coef(3)/100; %opsin gain %so stimulus can be in R*/sec (this is rate of increase in opsin activity per R*/sec)
