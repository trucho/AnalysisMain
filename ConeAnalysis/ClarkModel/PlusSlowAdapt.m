...
%%
% binary noise
load('/Users/juan/Dropbox/Cones_FredJuan/AdaptationModel/JuanCode/BinaryEx.mat')
Stm = decimate(BinaryEx.Stim50k(3, :), 10) * 4000;
NumPts = length(Stm);
tme = 1:NumPts;
Resp = decimate(BinaryEx.Data50k(3, :), 10);
...
%%
% saccade trajectory
% load('/Users/juan/Dropbox/Cones_FredJuan/AdaptationModel/JuanCode/EyeMovementsExample_092413Fc12vClamp.mat')
load('/Users/juan/Dropbox/Cones_FredJuan/AdaptationModel/JuanCode/EyeMovementsExample_100113Fc03.mat')
Stm = decimate(EyeMovementsExample.Stim, 20)/25;
Stm = [1:5000 Stm];
Stm(1:5000) = Stm(5001);
NumPts = length(Stm);
tme = 1:NumPts;
Resp = decimate(EyeMovementsExample.Mean,20);
