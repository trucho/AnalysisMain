...
% hGUI = fit_monoClarkKy(struct('ak_subflag',1),10); % found 2 good fits to dim-flash response that differ a lot.
% hGUI = fit_monoClarkKyClamped(struct('ak_subflag',0),10); % found 2 good fits to dim-flash response that differ a lot.



hGUI = fit_monoClark_ak_KyClamped(struct('plotFlag',0),10);
