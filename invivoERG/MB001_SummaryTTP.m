...
results = Sq821.results;

f1=getfigH(1);
set(f1,'XScale','log')
setLabels(f1,'I_{Flash} (cd/m^2)','Left a_{peak} (\muV)')

lH=lineH(results.vpre.iF,(results.vpre.a_t),f1);
lH.linemarkers;lH.color(colors(1,:));
set(lH.h,'DisplayName','avpre')
lH=lineH(results.vpost.iF,(results.vpost.a_t),f1);
lH.linemarkers;lH.color(colors(2,:));
set(lH.h,'DisplayName','avpost')
lH=lineH(results.dpre.iF,(results.dpre.a_t),f1);
lH.linemarkers;lH.color(colors(3,:));
set(lH.h,'DisplayName','adpre')
lH=lineH(results.dpost.iF,(results.dpost.a_t),f1);
lH.linemarkers;lH.color(colors(4,:));
...
lH=lineH(results.vpre.iF,(results.vpre.b_t),f2);
lH.linemarkers;lH.color(colors(1,:));
set(lH.h,'DisplayName','bvpre')
lH=lineH(results.vpost.iF,(results.vpost.b_t),f2);
lH.linemarkers;lH.color(colors(2,:));
set(lH.h,'DisplayName','bvpost')
lH=lineH(results.dpre.iF,(results.dpre.b_t),f2);
lH.linemarkers;lH.color(colors(3,:));
set(lH.h,'DisplayName','bdpre')
lH=lineH(results.dpost.iF,(results.dpost.b_t),f2);
lH.linemarkers;lH.color(colors(4,:));
...
eh=lH.errorbars(Avg.iF,nanmean(Avg.udb,1),nanstd(Avg.udb,1)./sqrt(4),[1 .5 .5],f6,'a_drugsd_u');
...
makeAxisStruct(f6,'h_gRatios',sprintf('erg/squirrel/invivo/MB001'));
...
drawnow
makeAxisStruct(hGUI.figData.plotR2,'a_dPost',sprintf('erg/squirrel/invivo/MB001'));
